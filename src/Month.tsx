import {Avatar, Badge, Box, Card, Group, Progress, Stack, Text, Title, Tooltip} from '@mantine/core';
			...
			<Stack>
				...
				<Group justify={'space-between'}>
					<Stack gap={'xs'}>
						<Tooltip label={'Spender'}>
							<svg width="22" height="22" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
								...
								<path fill="#FFAC33"
									  d="M21.276 22.166l-.006 5.94.497.59c.969-.884 1.9-1.878 2.705-2.996.835-1.158 1.805-2.149 2.828-2.986l-.483-.575-5.541.027z"/>
								<path fill="#FFE8B6"
									  d="M26.798 22.118L14.292 7.305c-1.016.836-1.992 1.811-2.822 2.964-.811 1.126-1.755 2.117-2.735 2.991l1.462 1.731-.001.001 11.075 13.114c.98-.875 1.913-1.876 2.725-3.003.83-1.152 1.805-2.126 2.82-2.962l-.019-.023h.001z"/>
								<path fill="#5C913B"
					...
					<Stack gap={'xs'} align={'flex-end'}>
						<Tooltip label={'Booster'}>
							<svg width="22" height="22" viewBox="0 0 10 16" fill="#FF73FA"
								 xmlns="http://www.w3.org/2000/svg">
								<path
									d="M5 0.5L0 5.5V10.5L5 15.5L10 10.5V5.5L5 0.5ZM8.75 9.9875L5 13.7375L1.25 9.9875V6.0125L5 2.2625L8.75 6.0125V9.9875Z"></path>
								<path
									d="M2.5 6.53751V9.46251L5 11.9625L7.5 9.46251V6.53751L5 4.03751L2.5 6.53751Z"></path>
							</svg>
						</Tooltip>
						<Avatar.Group>
							{boosters.map((booster) => <Donator key={booster} id={booster}/>)}
						</Avatar.Group>
					</Stack>
				</Group>
			</Stack>
