...
const donors = new Map<DonatorProps['id'], DonatorInfo>([
	...
	['130094115894329345', {name: 'Maverick Smith', avatar: '74c39b6fd45eec27cfeffb8e728c7961'}],
	...
	['439048480783335427', {name: 'HARLEKIN', avatar: '1634ecf635f0a600d2507cd3442381f7'}],
