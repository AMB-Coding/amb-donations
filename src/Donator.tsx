...
const donors = new Map<DonatorProps['id'], DonatorInfo>([
	...
	['130094115894329345', {name: 'Maverick Smith', avatar: 'a_34bb537cacc4265017c91758ffee06fc'}],
	['247342219667701770', {name: 'Asuma', avatar: 'a_1bf1676e45a74aaa9b4a2f0fd1d9a798'}],
	...
	['793276451049832470', {name: 'Mäxo', avatar: 'cecc78efd3d8593e2a12dbd0cc51c305'}],
	...
	['439048480783335427', {name: 'HARLEKIN', avatar: '51c621480f56d441681189ca9a9efd7c'}],
