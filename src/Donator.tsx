...
const donors = new Map<DonatorProps['id'], DonatorInfo>([
	...
	['229571426598780929', {name: 'Marvin', avatar: 'a3e0514c6a06bc66d231e0829fa52ba3'}],
	...
	['130094115894329345', {name: 'Maverick Smith', avatar: 'a_851bad99b73dbe0267102a296699381b'}],
	...
	['439048480783335427', {name: 'HARLEKIN', avatar: 'e1749465a4ad462302001c31730dafa4'}],
